...
api: "POST /api/v2/collaborator/purchase-orders/purchase-cart"
description: "Redeem all items from the user's shopping cart"
---

This endpoint allows collaborators to redeem all items currently in their shopping cart. The implementation validates the cart contents, handles special product requirements (like CEVER products), and processes the order through the purchase order microservice.
