...
api: "GET https://api.example.com/api/v2/collaborator/purchase-orders/shopping-cart"
description: "Retrieve current shopping cart contents for the authenticated collaborator"
---
