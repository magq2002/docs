...
api: "POST https://api.example.com/api/v2/collaborator/purchase-orders/direct-redemption"
description: "Create an immediate product redemption order for a collaborator"
---

## Overview

This endpoint allows collaborators to instantly redeem products using their available points. The system validates point balance, product availability, and delivery information before creating the order.
